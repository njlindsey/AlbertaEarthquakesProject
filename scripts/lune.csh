...
gmt gmtset PAPER_MEDIA letter PAGE_ORIENTATION landscape MEASURE_UNIT inch BASEMAP_TYPE plain PLOT_DEGREE_FORMAT D TICK_LENGTH 0.0c LABEL_FONT_SIZE 10 ANOT_FONT_SIZE 10 HEADER_FONT 1 ANOT_FONT 1 LABEL_FONT 1 HEADER_FONT_SIZE 18 FRAME_PEN 2p TICK_PEN 2p
gmt psbasemap -JH0/2.8i -R-30/30/-90/90 -Ba10f5g10:" ":/a10f5g10:" ":wesn -G200 -K -V -X2.5 -Y0.5 > lune_hammer_iplot1.ps
awk '{print $1,$2}' ./dfiles//sourcetype_patch_01.dat | gmt psxy -G120 -J -R -K -O -V >>lune_hammer_iplot1.ps
awk '{print $1,$2}' ./dfiles//sourcetype_patch_02.dat | gmt psxy -G255 -J -R -K -O -V >>lune_hammer_iplot1.ps
gmt psbasemap -JH0/2.8i -R-30/30/-90/90 -Ba10f5g10:" ":/a10f5g10:" ":wesn -K -O -V >> lune_hammer_iplot1.ps
awk '{print $1,$2}' ./dfiles//sourcetype_arc_03.dat | gmt psxy -W2p,0 -J -R -K -O -V >>lune_hammer_iplot1.ps
awk '{print $1,$2}' ./dfiles//sourcetype_arc_04.dat | gmt psxy -W2p,0 -J -R -K -O -V >>lune_hammer_iplot1.ps
awk '{print $1,$2}' ./dfiles//sourcetype_arc_05.dat | gmt psxy -W2p,0 -W2p,50/205/50 -J -R -K -O -V >>lune_hammer_iplot1.ps
awk '{print $1,$2}' ./dfiles//sourcetype_arc_06.dat | gmt psxy -W2p,0 -J -R -K -O -V >>lune_hammer_iplot1.ps
